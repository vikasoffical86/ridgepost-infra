# github.com/vikasoffical86/ridgepost-infra cea1b7f
...
=== FILE: modules/networking/versions.tf ===
terraform {
required_version=">=1.6"
required_providers {
aws={ source="hashicorp/aws", version="~> 5.70" }
...
=== FILE: modules/compute/versions.tf ===
terraform {
required_version=">=1.6"
required_providers {
aws={ source="hashicorp/aws", version="~> 5.70" }
...
=== FILE: modules/s3_secure/versions.tf ===
terraform {
required_version=">=1.6"
required_providers {
aws={ source="hashicorp/aws", version="~> 5.70" }
